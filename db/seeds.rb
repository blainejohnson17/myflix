...
Video.create(title: 'South Park', description: "Follows the misadventures of four irreverent grade-schoolers in the quiet, dysfunctional town of South Park, Colorado.", small_cover_url: '/tmp/south_park.jpg', large_cover_url: '/tmp/monk_large.jpg')